...
public class Configuracion {
  ...
  private void loadProperties() {
    InputStream is= this.getClass().getResourceAsStream("/".concat(Constantes.KAJOOL_PROPERTIES));
    try {
      ...
      LOG.info("Se cargo el archivo de default de ".concat(Constantes.KAJOOL_PROPERTIES));
      if(is!= null)
        this.properties.load(is);
    } // try
    catch (Exception e) {
      Error.mensaje(e, "Estar seguro que esta en el CLASSPATH ".concat(Constantes.KAJOOL_PROPERTIES));
    } // catch
  } // loadProperties
