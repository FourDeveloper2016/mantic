...
public class Filtro extends IBaseFilter implements Serializable {
  ...
  public StreamedContent getFile() {
    ...
    try {
      ...
      InputStream stream = FacesContext.getCurrentInstance().getExternalContext().getResourceAsStream((String)insumo.toValue("ruta"));
      if(stream== null)
      ...
      if(stream== null)
        stream = new URL(insumo.toString("ruta")).openStream();
      if(stream== null)
