 ...
 */
@ManagedBean(name = "kajoolUsuariosFiltro")
@ViewScoped
public class Filtro extends IBaseFilter implements Serializable {
	...
	/**
	 * *
	 * Metodo de interaccion cuando se presiona el link en la busqueda por Se
	 * realiza la consulta por perfil
	 *
	 * @param event
	 */
	...
	/**
	 * *
	 * Metodo de interaccion cuando se presiona el link en la busqueda por perfil
	 * Se realiza la consulta por perfil
	 *
	 * @param event
	 */
	...
	/**
	 * *
	 * Metodo de interacción cuando se presiona el botón de activiar usuario. Se
	 * verificar el estatus actual del usuario, si es activo. cambiar a inactivo o
	 * viceversa
	 *
	 * @param event
	 */
	...
	public void doEliminar() {
      ...
      persona= (TcJanalEmpleadosDto) DaoFactory.getInstance().findById(TcJanalEmpleadosDto.class, usuario.getIdEmpleado());			
			this.attrs.put("idUsuario", this.seleccionado.toLong("idKeyUsuario"));
