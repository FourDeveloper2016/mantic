...
public class Filtro extends Comun implements Serializable {
  ...
  private void loadFields() {
    this.tablasCampos= new ArrayList<>();		
		...
		this.tablasCampos.get(EExportarDatos.VISITAS.ordinal()- 1).add(new Field("nom_ent", ETypeField.VARCHAR, 40, 0));
		this.tablasCampos.get(EExportarDatos.VISITAS.ordinal()- 1).add(new Field("fecha", ETypeField.DATE, 0, 0));
		this.tablasCampos.get(EExportarDatos.VISITAS.ordinal()- 1).add(new Field("hr_ini", ETypeField.VARCHAR, 6, 0));
		this.tablasCampos.get(EExportarDatos.VISITAS.ordinal()- 1).add(new Field("hr_ter", ETypeField.VARCHAR, 6, 0));
		...
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("cve_upm", ETypeField.VARCHAR, 6, 0));
		...
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("nom_tit", ETypeField.VARCHAR, 40, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("pat_tit", ETypeField.VARCHAR, 40, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("mat_tit", ETypeField.VARCHAR, 40, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("calle", ETypeField.VARCHAR, 100, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("num_ext", ETypeField.VARCHAR, 60, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("num_int", ETypeField.VARCHAR, 60, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("colonia", ETypeField.VARCHAR, 100, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("cp", ETypeField.VARCHAR, 5, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("telef", ETypeField.VARCHAR, 60, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("referencia", ETypeField.VARCHAR, 300, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("entre_ca1", ETypeField.VARCHAR, 200, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("entre_ca2", ETypeField.VARCHAR, 200, 0));
		this.tablasCampos.get(EExportarDatos.CARATULA.ordinal()- 1).add(new Field("calle_atra", ETypeField.VARCHAR, 200, 0));		
		...
		this.tablasCampos.get(EExportarDatos.PERSONAS.ordinal()- 1).add(new Field("cve_upm", ETypeField.VARCHAR, 6, 0));
		this.tablasCampos.get(EExportarDatos.PERSONAS.ordinal()- 1).add(new Field("id_per", ETypeField.INTEGER, 11, 0));
		...
		this.tablasCampos.get(EExportarDatos.PERSONAS.ordinal()- 1).add(new Field("a_paterno", ETypeField.VARCHAR, 40, 0));
		this.tablasCampos.get(EExportarDatos.PERSONAS.ordinal()- 1).add(new Field("a_materno", ETypeField.VARCHAR, 40, 0));
		this.tablasCampos.get(EExportarDatos.PERSONAS.ordinal()- 1).add(new Field("nombre", ETypeField.VARCHAR, 40, 0));
		...
		this.tablasCampos.get(EExportarDatos.PERSONAS.ordinal()- 1).add(new Field("informante", ETypeField.VARCHAR, 50, 0));
		this.tablasCampos.get(EExportarDatos.PERSONAS.ordinal()- 1).add(new Field("recertific", ETypeField.VARCHAR, 4, 0));		
		this.tablasCampos.get(EExportarDatos.PERSONAS.ordinal()- 1).add(new Field("factor", ETypeField.INTEGER, 10, 0));		
		this.tablasCampos.add(new ArrayList<Field>());
		...
		this.tablasCampos.get(EExportarDatos.FAMILIA.ordinal()- 1).add(new Field("cve_upm", ETypeField.VARCHAR, 6, 0));
		...
		this.tablasCampos.get(EExportarDatos.FAMILIA.ordinal()- 1).add(new Field("factor", ETypeField.INTEGER, 10, 0));		
		this.tablasCampos.add(new ArrayList<Field>());
		...
		this.tablasCampos.get(EExportarDatos.MODULO.ordinal()- 1).add(new Field("cve_upm", ETypeField.VARCHAR, 6, 0));
		...
		this.tablasCampos.get(EExportarDatos.MODULO.ordinal()- 1).add(new Field("factor", ETypeField.INTEGER, 10, 0));		
		this.tablasCampos.add(new ArrayList<Field>());
